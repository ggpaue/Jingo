	...
	<div id="wrapper">
		<div class = "interface">
			...
			<div class="header">
				<h4>Repeat</h4>
				<form>
					<input type = "button" value = "Cancel" class = "leftbutton" onclick='location.href = "timefiltersettings.php"'/>
				</form>
				<form action="mynotes.php">
					<input type="button" value="Save" class="rightbutton" onclick='location.href="timefiltersettings.php"'/>
				</form>
			</div>
			<div class="content">
